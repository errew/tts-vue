  ...
  <div class="main">
    ...
    >
      ...
      >
        ...
        <el-button type="primary" @click="sendToChatGPT"
    ...
    <div class="input-area" v-show="page.asideIndex == '2'">
      <el-table :data="tableData" height="calc(100vh - 170px)" style="width: 100%">
        <el-table-column prop="fileName" :label="t('main.fileName')" show-overflow-tooltip="true" />
        <el-table-column prop="filePath" :label="t('main.filePath')" show-overflow-tooltip="true" />
        <el-table-column
          prop="fileSize"
        ...
        />
        <el-table-column prop="status" :label="t('main.status')" width="70">
    ...
    <div class="main-config-page" v-if="page.asideIndex == '4'">
      <iframe class="doc-frame" src="https://loker-page.lgwawork.com/home.html"> </iframe>
    </div>
  </div>
</template>
...
const openInFolder = (val: any) => {
  shell.showItemInFolder(
    path.join(config.value.savePath, val.fileName.split(path.extname(val.fileName))[0] + '.mp3')
  )
}
</script>
